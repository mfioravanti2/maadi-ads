...
# Date   : 01/18/2013
# File   : test_ConstraintSingleString_rspec.rb
# License: Creative Commons Attribution
#
# Summary: This is the rspec unit test for the ConstraintSingleString class

require 'rubygems'
require 'rspec'

require_relative '../../../../lib/custom/procedure/ConstraintSingleString'

describe Maadi::Procedure::ConstraintSingleString do
  it 'generates a single string of characters up to a maximum specified length' do
    length_a = rand(25)
    length_b = length_a + rand(25)

    constraint = Maadi::Procedure::ConstraintSingleString.new(length_a, length_b)
